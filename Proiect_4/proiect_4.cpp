...
int main()
{
    Cafea *obiect_cafea = new Cafea[3];
    Angajat *obiect_angajat = new Angajat[3];
    Espressor *obiect_espressor = new Espressor[3];
    /*
        cout << "" << endl;
        cout << *obiect_cafea << endl;
        cout << "" << endl;
        cout << *obiect_angajat << endl;
        cout << "" << endl;
        cout << *obiect_espressor << endl;
     */
    for (int i = 0; i < 3; i++)
    {
        cout << "Cafea " << (i + 1) << " : " << endl;
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        cin >> obiect_angajat[i];
    }
    for (int i = 0; i < 3; i++)
    {
        cout << obiect_angajat[i];
    }

    for (int i = 0; i < 3; i++)
    {
        cout << "Espressor" << (i + 1) << ":" << endl;
        cin >> obiect_espressor[i];
    }
    for (int i = 0; i < 3; i++)
    {
        cout << obiect_espressor[i];
    }

    // lucru cu matrice de tipul unei clase
    Cafea **matrice_cafea = new Cafea *[2];
    for (int i = 0; i < 2; i++)
    {
        matrice_cafea[i] = new Cafea[2];
    }
    // citeste matrice
    for (int i = 0; i < 2; i++)
    {
    ...
    for (int i = 0; i < 2; i++)
    {
        for (int j = 0; j < 2; j++)
        {
            ...
            cout << matrice_cafea[i][j] << endl;
        }
    }

    delete[] obiect_cafea;
    delete[] obiect_angajat;
    delete[] obiect_espressor;

    for (int i = 0; i < 2; i++)
    {
        delete[] matrice_cafea[i];
    }
    delete[] matrice_cafea;
